...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public List<Meal> getAll(int userId) {
        return getBetween(LocalDateTime.of(DateTimeUtil.MIN_DATE, LocalTime.MIN), LocalDateTime.of(DateTimeUtil.MAX_DATE, LocalTime.MAX), userId);
    }
